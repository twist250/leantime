...
<form action="" method="post" class="stdform">
    ...
    <div class="row-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                        ...
                        <div class="span6">
                            <select name="clientId" id="clientId">
                                ...
                                <?php foreach ($this->get('clients') as $row) { ?>
                                    <option value="<?php echo $row['id']; ?>" <?php if ($project['clientId'] == $row['id']) { ?> selected=selected <?php } ?>><?php $this->e($row['name']); ?></option>
                                <?php } ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="span6">
                            <select name="projectState" id="projectState">
                                <option value="0" <?php if ($project['state'] == 0) { ?> selected=selected <?php } ?>><?php echo $this->__('label.open'); ?></option>

                                <option value="-1" <?php if ($project['state'] == -1) { ?> selected=selected <?php } ?>><?php echo $this->__('label.closed'); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <label class="span4 control-label" for="name">Start Date</label>
                        <div class="span6">
                            <input type="date" name="timelineFrom" id="timelineFrom" class="input-large" value="<?php $this->e($project['timelineFrom']) ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label class="span4 control-label" for="name">End Date</label>
                        <div class="span6">
                            <input type="date" name="timelineTo" id="timelineTo" class="input-large" value="<?php $this->e($project['timelineTo']) ?>" />
                        </div>
                    </div>
        ...
        <div class="span4">
            <div class="row-fluid">
                <div class="span12">
                    <h4 class="widgettitle title-light"><span class="iconfa iconfa-group"></span><?php echo $this->__('label.team_members'); ?></h4>
                    <div class="form-group">
                        ...
                        <div class="assign-container">
                            <?php foreach ($this->get('availableUsers') as $row) { ?>
                                ...
                                <p class="half">
                                    <input type='checkbox' name='editorId[]' id="user-<?php echo $row['id'] ?>" value='<?php echo $row['id'] ?>' <?php if (in_array($row['id'], $project['assignedUsers'])) : ?> checked="checked" <?php
                                                                                                                                                                                                                                endif; ?> />

                                    <label for="user-<?php echo $row['id'] ?>"><?php printf($this->__('text.full_name'), $this->escape($row['firstname']), $this->escape($row['lastname']))  ?>
                                        <?php echo $row['role'] == 60 && in_array($row['id'], $project['assignedUsers']) == 1 ? "(PM)" : "";
                                        ?>
                                    </label>
            ...
            <div class="row-fluid">
                <div class="span12 padding-top">
                    <h4 class="widgettitle title-light"><span class="fa fa-money-bill-alt"></span><?php echo $this->__('label.budgets'); ?></h4>
                    <div class="form-group">
                ...
                <div class="span6">
                    <div class="span6">
                        <select name="settingsTicketLayout" id="ticketLayout">
                            <option value="0" <?php if ($_SESSION["projectsettings"]['ticketLayout'] == 0) { ?> selected=selected <?php } ?>><?php echo $this->__('label.classic'); ?></option>

                            <option value="1" <?php if ($_SESSION["projectsettings"]['ticketLayout'] == 1) { ?> selected=selected <?php } ?>><?php echo $this->__('label.oneView'); ?></option>
                ...
                <div class="span6">
                    <div class="span6">
                        <select name="settingsCommentOrder" id="commentOrder">
                            <option value="0" <?php if ($_SESSION["projectsettings"]['commentOrder'] == "0") { ?> selected=selected <?php } ?>><?php echo $this->__('label.uptodown'); ?></option>

                            <option value="1" <?php if ($_SESSION["projectsettings"]['commentOrder'] == "1") { ?> selected=selected <?php } ?>><?php echo $this->__('label.downtoup'); ?></option>
